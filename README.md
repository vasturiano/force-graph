...
| <b>linkLineDash</b>([<i>str</i> or <i>fn</i> or <i>num array</i>]) | Link object accessor function (`fn(link)`) or attribute (e.g. `'type'`) or number array (e.g. `[5, 15]`) to determine if a line dash should be applied to this rendered link. Refer to [the HTML canvas setLineDash API for example values](https://developer.mozilla.org/en-US/docs/Web/API/CanvasRenderingContext2D/setLineDash) | `[]` |
